 ...
 * @brief Implementación del driver del SN74HC595N.
 *
 * @details
...
/**
 * @brief Configuración SPI.
 * * @details 
 * El SN74HC595N acepta hasta ~25-30 MHz según variante, muy por encima de lo 
 * que necesitamos para refrescar LEDs (se actualizan como mucho un par de veces 
 * por segundo) — 1 MHz da margen de sobra sin preocuparse por integridad de 
 * señal en cables de protoboard largos. 
 * Modo SPI 0 (CPOL=0, CPHA=0): el SN74HC595 mete el bit en SER con SRCLK en bajo
...
/**
 * @brief Inicializa el hardware necesario para el registro de desplazamiento.
 * * @return true si los dispositivos SPI y GPIO están listos, false de lo contrario.
 */
...
/**
 * @brief Envía un byte completo al registro de desplazamiento y actualiza las salidas.
 * * @param value Byte (8 bits) que representa el estado deseado para los LEDs Q0-Q7.
 */
